...
* filename:BookTxtBLL_hrsx8
* guid:38457487-ecb3-43e8-9246-cb9bda5abcf9
* auth:lip86
* date:2018-01-31 21:44:59
* desc:
*
*=====================================================================*/
...
namespace Kasim.Core.BLL.HtmlAgilityPack
{
    public class BookTxtBLL_hrsx8: IBookTxtBLL
    {
        ...
        public List<Book> GetMenuList()
        {
            ...
            var xPath = @"/html[1]/body[1]/div[5]/div[1]/div[3]/ul[1]";//有多目录
            //var xPath = @"/html[1]/body[1]/div[5]/div[1]/div[7]/ul[1]";//少目录
        ...
        public Book GetContent(Book book)
        {
            try
            {
                ...
                var document = new HtmlDocument();
                document.LoadHtml(html);
                var xPath = @"/html[1]/body[1]/div[3]/div[1]/div[5]/div[1]";
                var reqObj = document.DocumentNode.SelectSingleNode(xPath);
                if (reqObj != null)
                {
                    foreach (var text in reqObj.ChildNodes)
                    {
