...
** Copyright (C) 2017 
**
** file：BookTxtBLL_biqugex
** desc：
** 
** auth：KasimYe (KASIM)
** date：2018-02-18 22:40:38
**
** Ver.：V1.0.0
**----------------------------------------------------------------*/
...
{
    public class BookTxtBLL_biqugex: IBookTxtBLL
    {
        ...
        public List<Book> GetMenuList()
        {
            ...
            var xPath = @"/html[1]/body[1]/div[4]/dl[1]";
        ...
        public Book GetContent(Book book)
        {
            try
            {
                ...
                var document = new HtmlDocument();
                document.LoadHtml(html);
                var xPath = @"/html[1]/body[1]/div[3]/div[2]/div[3]";
                var reqObj = document.DocumentNode.SelectSingleNode(xPath);
                if (reqObj != null)
                {
