...
** Copyright (C) 2017 
**
** file：BookTxtBLL_wanshu
** desc：
** 
** auth：KasimYe (KASIM)
** date：2018-02-18 22:17:57
**
** Ver.：V1.0.0
**----------------------------------------------------------------*/
...
{
    public class BookTxtBLL_wanshu: IBookTxtBLL
    {
        ...
        public List<Book> GetMenuList()
        {
            ...
            var xPath = @"/html[1]/body[1]/div[3]/div[2]/ul[1]";
        ...
        public Book GetContent(Book book)
        {
            try
            {
                ...
                var document = new HtmlDocument();
                document.LoadHtml(html);
                var xPath = @"/html[1]/body[1]/div[2]/div[2]/div[3]";
                var reqObj = document.DocumentNode.SelectSingleNode(xPath);
                if (reqObj != null)
                {
