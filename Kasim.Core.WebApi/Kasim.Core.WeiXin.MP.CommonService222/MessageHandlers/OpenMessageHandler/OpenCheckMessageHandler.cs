...
using Kasim.Core.WeiXin.MP.CommonService.CustomMessageHandler;
using Kasim.Core.WeiXin.MP.CommonService.OpenTicket;
...
namespace Kasim.Core.WeiXin.MP.CommonService.MessageHandlers.OpenMessageHandler
{
    /// <summary>
    /// 开放平台全网发布之前需要做的验证
    /// </summary>
