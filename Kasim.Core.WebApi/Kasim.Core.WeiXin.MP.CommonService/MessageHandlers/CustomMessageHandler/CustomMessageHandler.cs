...
using Kasim.Core.WeiXin.MP.CommonService.Utilities;
#else
using Microsoft.AspNetCore.Http;
using Kasim.Core.WeiXin.MP.CommonService.Utilities;
#endif

namespace Kasim.Core.WeiXin.MP.CommonService.CustomMessageHandler
{
    /// <summary>
    /// 自定义MessageHandler
    ...
    public partial class CustomMessageHandler : MessageHandler<CustomMessageContext>
    {
        ...
        private string appId = ModelFactory.SenparcWeixinSetting.WeixinAppId; //"appId";
        private string appSecret = ModelFactory.SenparcWeixinSetting.WeixinAppSecret; //"appSecret";
...
//                })
                ...
                .Default(() =>
                {
                    ...
                    return ResponseContext.GetOpenResponseMessage(requestMessage);
                })
                ////“一次订阅消息”接口测试
                //.Keyword("订阅", () =>
                //{
